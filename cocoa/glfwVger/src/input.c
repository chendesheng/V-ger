...
void _glfwTimer(_GLFWwindow* window)
{
    if (window->callbacks.timer)
        window->callbacks.timer((GLFWwindow*) window);
}

void _glfwDraw(_GLFWwindow* window)
{
    if (window->callbacks.draw)
        window->callbacks.draw((GLFWwindow*) window);
}
//////////////////////////////////////////////////////////////////////////
//////                        GLFW public API                       //////
//////////////////////////////////////////////////////////////////////////
