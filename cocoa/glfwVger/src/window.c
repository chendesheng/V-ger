                                     ...
                                     GLFWwindow* share)
{
    ...
    // {
    //     printf("_glfwRefreshContextAttribs false");
    ...
    // printf("after _glfwRefreshContextAttribs");
...
GLFWAPI GLFWtimerfun glfwSetTimerCallback(GLFWwindow* handle,
                                                  GLFWtimerfun cbfun)
{
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    _GLFW_SWAP_POINTERS(window->callbacks.timer, cbfun);
    return cbfun;
}


GLFWAPI GLFWdrawfun glfwSetDrawCallback(GLFWwindow* handle,
                                                  GLFWdrawfun cbfun)
{
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    _GLFW_SWAP_POINTERS(window->callbacks.draw, cbfun);
    return cbfun;
}
...
GLFWAPI void glfwPlatformSetNeedsDisplay(GLFWwindow* window, int b)
{
...
{
    _glfwPlatformShowLeftTime((_GLFWwindow*)window, time, leftTime, percent);
}

GLFWAPI void showOrHideStartUpView(GLFWwindow *window, int b)
{
    _showOrHideStartUpView((_GLFWwindow *)window, b);
}
