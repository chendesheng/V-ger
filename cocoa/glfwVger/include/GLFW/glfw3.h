...
GLFWAPI GLFWtimerfun glfwSetTimerCallback(GLFWwindow* window, GLFWtimerfun cbfun);
GLFWAPI GLFWdrawfun glfwSetDrawCallback(GLFWwindow* window, GLFWdrawfun cbfun);
