...
g++ -c -O2 -m64 \
  ...
  cld2_generated_distinctoctachrome0122.cc  cld_generated_score_quad_octa_0122_2.cc cld.cc  \

libtool -static -o libcld2.a *.o
rm *.o
...
g++ -c -O2 -m64 \
  ...
  cld2_generated_distinctocta0122.cc  cld_generated_score_quad_octa_0122.cc cld.cc  \

libtool -static -o libcld2_full.a *.o
rm *.o
